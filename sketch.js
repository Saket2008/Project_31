...
function setup() {
  ...
  for (var a = 42.5; a <= 470; a += 50){
    plinkos.push(new Plinko(a, 100, 10, "red"));
  }

  for (var b = 17.5; b <= 470; b += 50){
    plinkos.push(new Plinko(b, 200, 10, "skyblue"));
  }

  for (var c = 42.5; c <= 470; c += 50){
    plinkos.push(new Plinko(c, 300, 10, "green"));
  }

  for (var e = 17.5; e <= 470; e += 50){
    plinkos.push(new Plinko(e, 400, 10, "pink"));
  }
}
